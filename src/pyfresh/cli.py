...
Examples:
  ...
  %(prog)s my-project --config my-config.yaml
    ...
    parser.add_argument(
        "--author", help="Project author name (default: from config or prompt)"
    )

    parser.add_argument(
        "--email", help="Project author email (default: from config or prompt)"
    )

    parser.add_argument("--description", help="Project description (default: empty)")
